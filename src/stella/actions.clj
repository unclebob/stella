...
;; {:version 1, :tested-at "2026-06-26T15:19:53.460443-05:00", :module-hash "-211100532", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 2, :hash "-2002190841"} {:id "defn/event->action", :kind "defn", :line 4, :end-line 10, :hash "1106798315"} {:id "defn/action->effect", :kind "defn", :line 12, :end-line 18, :hash "772225751"}]}
